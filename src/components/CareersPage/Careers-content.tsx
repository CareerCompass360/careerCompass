...
export default function LandingPageContentVariation1() {
  return (
    <main className="min-h-screen bg-stone-50">
      ...
      <div className="pt-16">
        <section className="relative overflow-hidden bg-linear-to-br from-amber-50/50 via-stone-50 to-yellow-50/30 px-4 md:px-8 py-20 sm:py-28">
          <div className="absolute inset-0 bg-grid-amber-100/30 mask-[linear-gradient(0deg,#fafaf9,rgba(250,250,249,0.6))] -z-10" />
          <div className="absolute top-20 right-20 h-32 w-32 rounded-full bg-linear-to-br from-amber-400/20 to-yellow-400/20 blur-2xl animate-pulse" />
          <div className="absolute top-40 left-20 h-24 w-24 rounded-full bg-linear-to-br from-yellow-400/15 to-amber-400/15 blur-xl animate-bounce" />
          <div className="absolute bottom-20 right-40 h-40 w-40 rounded-full bg-linear-to-br from-amber-200/20 to-yellow-200/20 blur-3xl" />
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="mt-10">
                <a
                  href="#categories"
                  className="inline-flex items-center gap-3 px-8 py-4 bg-linear-to-r from-amber-600 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Explore Careers
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={idx} className="flex flex-col items-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-amber-100 shadow-sm">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-br from-amber-400 to-yellow-400 mb-3">
        ...
        <section id="categories" className="px-4 md:px-8 py-16 md:py-20 bg-linear-to-b from-stone-50 via-amber-50/30 to-stone-50">
