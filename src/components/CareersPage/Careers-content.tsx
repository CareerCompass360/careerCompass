            ...
            {[
              {
                ...
                desc: "Step-by-step progression roadmaps from entry-level to leadership roles.",
              },
              {
                icon: BookOpen,
                title: "Learning Resources",
                desc: "Guides, articles, and practical learning resources for each role.",
              },
              {
                icon: Target,
                title: "Skills & Support",
                desc: "Core skills, certifications, and practical preparation advice.",
              },
            ].map((feature, idx) => (
              <motion.div
                key={idx}
                ...
                >
                  <Link href={`/careers/category/${category.id}`}>
                    <div className="group h-full rounded-2xl border border-amber-100 bg-white/90 backdrop-blur-sm p-5 shadow-sm hover:shadow-md hover:border-amber-300 transition-all">
                      ...
                      <p className="text-xs text-amber-800/85 leading-relaxed mb-4">
